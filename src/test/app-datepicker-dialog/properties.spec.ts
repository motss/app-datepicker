...
describe(name, () => {
  describe('updates via properties', () => {
    ...
    it(`renders with 'showWeekNumber'`, async () => {
      ...
      isTrue(el.showWeekNumber, `Datepicker dialog's 'showWeekNumber' not updated`);
      isTrue(t.elem.showWeekNumber, `Datepicker's 'showWeekNumber' not updated`);
    ...
    it(`renders with correct 'landscape'`, async () => {
      ...
      strictEqual(
        getComputedStylePropertyValue(t.elem, 'display'),
        'flex',
